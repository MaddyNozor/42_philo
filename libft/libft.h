...
/*   Updated: 2024/10/15 17:16:29 by mairivie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// Affiche un caractère et renvoie le nombre de caractères imprimés.
int			ft_print_char(char c);

// Affiche une chaîne de caractères et renvoie le nb de caractères imprimés.
int			ft_print_string(char *str);

// Affiche une adresse mémoire en hexadécimal et 
//renvoie le nombre de caractères imprimés.
int			ft_print_ptr(unsigned long long ptr);

// Affiche un entier signé et renvoie le nombre de caractères imprimés.
int			ft_print_nbr(int nbr);

// Affiche un entier non signé et renvoie le nombre de caractères imprimés.
int			ft_print_unsigned(unsigned int usgn_nbr);

// Affiche un nombre en hexadécimal
// (en majuscules ou minuscules) selon le caractère spécifié.
//  renvoie le nombre de caractères imprimés.
int			ft_print_hexa(char c, unsigned int hexa);

// Gère l'affichage du type spécifié par 'c' 
// dans la liste d'arguments variadiques.
int			ft_print_type(char c, va_list args);

// Ma version de print_f
...
// Free and set everything to NULL. Return NULL.
void		*free_all(char *ptr);

//NULL terminate a string and return it.
...
// Returns a line read from a file descriptor or NULL if there is nothing else 
//to read, or an error occurred
char		*get_next_line(int fd);

// Reads a line from the file descriptor, dynamically resizing the buffer.
// Returns the read line or handles errors.
char		*read_line(int fd, char *line, ssize_t *size_line, \
					struct s_gnl *data);

// Refills the buffer with data read from the file descriptor.
void		refill_buffer(int fd, struct s_gnl *data);

// Resizes the line buffer, updates its size, and copies existing content.
// Returns the resized buffer or handles errors.
